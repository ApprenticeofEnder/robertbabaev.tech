...
<div class="flex flex-col justify-center py-48">
    <div class="grid md:grid-cols-2 md:divide-x divide-white">
        <div class="flex flex-col justify-center">
            <h1 class="w-full animate-pulse">ERROR 404</h1>
            <h2 class="w-full text-center">Looks like the page you were looking for doesn't exist. Head <a href="/home">home?</a></h2>
        </div>
        <div class="p-14">
